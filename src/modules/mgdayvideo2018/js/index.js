...
$(function () {
  ...
  let lottery = new Lottery({ waiting: 2000, downMax: 300 });
  let isLimit = false; // 是否限流页面
  let currentShareCountTotal = 0;

  let shareType = null; // 分享的js对象
  let title = '2018网络视听年度盛典，high翻全场';
  let description = '好礼多多，咪咕会员0.99元起';
  let picture = 'http://s.migu.cn/stN/mgdayvideo2018/static/banner.png';
  ...
  activityReg.click(function () {
    iosDialog({
      ...
      <div class="dialog-reg-desc">
        ...
        <div class="dialog-reg-right">至2018年11月30日结束</div>
      </div>
      <div class="dialog-reg-desc">
