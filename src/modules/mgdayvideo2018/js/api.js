...
export default {
  loginJudge: API('/migu/netWorkVideo/loginJudge.action'),
  queryRemainingTimes: API('/migu/netWorkVideo/queryRemainingTimes.action'),
  winDrawChance: API('/migu/netWorkVideo/winDrawChance.action'),
  analyzeRedirect: API('/migu/netWorkVideo/redirect.action'),
  luckyDraw: API('/migu/netWorkVideo/luckyDraw.action'),
  winningRecharge: API('/migu/netWorkVideo/winningRecharge.action'),
};