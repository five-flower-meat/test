...
export default {
  loginJudge: API('/migu/miguhui/loginJudge.action'),
  queryRemainingTimes: API('/migu/miguhui/queryRemainingTimes.action'),
  winDrawChance: API('/migu/miguhui/winDrawChance.action'),
  analyzeRedirect: API('/migu/miguhui/redirect.action'),
  luckyDraw: API('/migu/miguhui/luckyDraw.action'),
  winningRecharge: API('/migu/miguhui/winningRecharge.action'),
};